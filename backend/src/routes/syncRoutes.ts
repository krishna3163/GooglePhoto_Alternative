...
router.get('/state', requireAuth, async (req: AuthRequest, res: Response, next) => {
  try {
...
router.get('/bootstrap', requireAuth, async (req: AuthRequest, res: Response, next) => {
  try {
...
router.post('/mutations', requireAuth, async (req: AuthRequest, res: Response, next) => {
  try {
